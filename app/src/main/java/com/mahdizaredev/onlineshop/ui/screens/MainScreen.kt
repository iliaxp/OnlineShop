...
import com.mahdizaredev.onlineshop.ui.components.TopAppView
...
fun MainScreen(activity: MainActivity) {
    ...
    val basketViewModel = ViewModelProvider(activity).get(
        BasketEntityViewModel::class.java
    )
    val userEntityViewModel = ViewModelProvider(activity).get(
        UserEntityViewModel::class.java
    )
    basketViewModel.getAllBasketLive().observe(activity) {
        basketViewModel.dataList.value = it
    }
    userEntityViewModel.getCurrentUser().observe(activity) {
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable("proceedToPayment") {
                fullScreen = true
                UserPaymentScreen(navController, basketViewModel, userEntityViewModel,activity)
            }
            composable(
